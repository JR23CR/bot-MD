...
let replit = `*◎ R E P L I T*\n\nhttps://replit.com/github/JR23CR/bot-MD`
let heroku = `*◎ H E R O K U*\n\nhttps://heroku.com/deploy?template=https://github.com/JR23CR/bot-MD`
...
//CÓDIGO CREADO GRACIAS A https://github.com/Azami19 & https://github.com/JR23CR
case isCommand9:
try{
...
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/JR23CR' : official[1][0] == String(contact[0]) ? 'https://github.com/elrebelde21' : official[2][0] == String(contact[0]) ? 'https://github.com/Azami19' : official[3][0] == String(contact[0]) ? 'https://github.com/Abiguelreyes75' : md
