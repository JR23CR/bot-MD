...
<p align="center">
<a href="https://github.com/JR23CR/bot-MD"><img title="bot-MD" src="https://img.shields.io/badge/BOT--MD-blue?colorA=%233CCED8&colorB=%233CCED8&style=for-the-badge"></a>
</p>
...
```
```bash
apt update -y && yes | apt upgrade && pkg install -y bash wget && wget -O - https://raw.githubusercontent.com/JR23CR/bot-MD/master/gatalite.sh | bash
```
#### EN CASO QUE QUIERA USAR ESTE MÉTODO DEBE DE EDITAR (Previo a una Bifurcación)
- [`Repositorio`](https://github.com/JR23CR/bot-MD/blob/main/gatalite.sh#L155)
- [`Nombre del Bot`](https://github.com/JR23CR/bot-MD/blob/main/gatalite.sh#L159)
- Actualizar: `https://raw.githubusercontent.com/JR23CR/bot-MD/main/gatalite.sh`
...
git clone https://github.com/JR23CR/bot-MD
cd bot-MD
yarn install
npm install
npm start
...
- INICIAR
> Use estos comandos dentro de la carpeta bot-MD
```bash
...
```
- REANUDAR 
> Reanudar los procesos, usar dentro de la carpeta bot-MD
```bash
pm2 start index.js 
```
- VISUALIZAR EL PROCESO
> Usar dentro de la carpeta bot-MD para ver en tiempo real
```bash
pm2 logs 
```
...
<a target="_blank" href="https://replit.com/github/JR23CR/bot-MD"><img alt="Run on Replit" src="https://binbashbanana.github.io/deploy-buttons/buttons/remade/replit.svg"></a>
...
### 💠 [`IDIOMAS DISPONIBLES PARA EL BOT`](https://github.com/JR23CR/bot-MD/blob/main/config.js#L31)
> **Multi Lenguaje Dinámico GB:** Disponibilidad de usar varios idiomas simultáneamente.
#### ✨ Español  [`Editar Idioma`](https://github.com/JR23CR/bot-MD/blob/main/lib/idiomas/espanol.js)
#### ✨ Inglés (English) [`Edit Language`](https://github.com/JR23CR/bot-MD/blob/main/lib/idiomas/ingles.js)
#### ✨ Portugués (Português) [`Idioma de Edição`](https://github.com/JR23CR/bot-MD/blob/main/lib/idiomas/portugues.js)
#### ✨ Indonesio (Bahasa Indonesia) [`Mengedit Bahasa`](https://github.com/JR23CR/bot-MD/blob/main/lib/idiomas/indonesio.js)
#### ✨ Árabe (عرب) [`عدل اللغة`](https://github.com/JR23CR/bot-MD/blob/main/lib/idiomas/arabe.js)
#### ✨ Alemán (Deutsch) [`Sprache bearbeiten`](https://github.com/JR23CR/bot-MD/blob/main/lib/idiomas/aleman.js)
#### ✨ Italiano (Italiano) [`Modifica lingua`](https://github.com/JR23CR/bot-MD/blob/main/lib/idiomas/italiano.js)
----
...
### 👑 CREADOR
[![JR23CR](https://github.com/JR23CR.png?size=100)](https://github.com/JR23CR)

###  collaborators
<a href="https://github.com/JR23CR/bot-MD/graphs/contributors">
<img src="https://contrib.rocks/image?repo=JR23CR/bot-MD" />
</a>
